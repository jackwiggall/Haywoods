-- Product
INSERT INTO Product (sku_code, name, description, price, category)
VALUES (
    110001,
  ...
  (
    410002,
    'Lampost Light',
    'More of a rustic look for the budding artists of the world, make sure these lights add their own finished look hanging next to the murial on the concrete wall you just freshly painted',
    39.99,
    'Lighting'
  ),
  (
    410003,
    'Round Glass Lights',
    'Who loves bubbles? I know I do, and you too can show your love for bubbles with this collection of hanging ceiling lights shaped like pretty bubbles in your room providing a natural lighting look',
    45.55,
    'Lighting'
  ),
  (
    410004,
    'Cage Lights',
    'Have you room neat tidy and organised with these lights, with a sleek look and in a straight line they add a sharp and clean finish to any room',
    31.99,
    'Lighting'
  ),
  (
    ...
    'These floating shelves add a simple, effective and attractive way of removing the clutter in your room, or just to put your favourite collectables and photographs on display, with a basic simple colour to blend in whilst your items stand out',
    34.99,
    'Storage'
  ),
  (
    510002,
    'Woden Shelving Cabinet',
  ...
  (
    520004,
    'Organisation boxes',
    'Smaller boxes means space for more of the same, using five of these boxes let you organise your belongings into refined categories making searching and storing efficient',
    02.00,
    'Storage'
  ),
  (
