      ...
      <div class="w3-container" style="margin-top:80px">
        ...
        <div class="row p-2 bg-primary dropshadow">
          ...
          <div class="col float-end">
            <!--Buttons-->
            <div class="float-end">
              <h3 class="p-3 border border-dark bg-light w300">Total £<strong
                  id="totalPrice"><?php echo $totalPrice; ?></strong></h3><br>
              ...
              <button type="submit" class="btn btn-light mt-1 border border-dark w300 center" id="payCardBtn">Pay
                Card</button>
              <br>
              <button type="submit" class="btn btn-light mt-1 border border-dark w300 center" id="payCashBtn">Pay
                Cash</button>
              <br>
              ...
              <div id="payCardBox" class="text-white hide">
                Card reader has detected card<br> ending in <strong
                  id="card-last4Digits"><?php echo rand(1000, 9999); ?></strong>
              </div>
